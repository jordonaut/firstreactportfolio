        ...
        <div className="max-w-5xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-green-700 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition-all">
                    <h3 className="text-xl font-semibold mb-2">Boeing Virtual Airplane</h3>
                    <p>At Boeing's Learner Solution Program, I was responsible for the look & feel of its flagship product: Virtual Airplane. During that time, I implemented a design system, redesigned the flow of several features, and did some really cool work on dark mode.</p>
                    <div className="mb-2 p-2.5 flex items-start justify-items-center">
                        {["Design Systems", "Custom Icongraphy", "User Research", "Facilitation"].map((tech,key) => (
                             <span key={key}
